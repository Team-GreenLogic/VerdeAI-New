"""Missing Requirements service — aio-pika consumer entrypoint."""
...
_QUEUE = "analyses.missing"
_MAX_RETRIES = 12
_RETRY_DELAY = 5


async def _run() -> None:
    logger.info("Missing Requirements service starting", queue=_QUEUE)
...
async def _shutdown() -> None:
    ...
    logger.info("Missing Requirements service shut down")

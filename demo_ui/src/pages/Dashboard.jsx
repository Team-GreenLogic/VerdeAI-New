    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="animate-fade-in-up" style={{ animationDelay: '350ms' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link
            to="/analyses"
            className="flex flex-col items-center gap-3 rounded-2xl bg-gradient-to-br from-brand-500 to-brand-700 hover:from-brand-600 hover:to-brand-800 text-white p-6 text-center transition-all duration-300 shadow-lg shadow-brand-200 hover:shadow-xl hover:shadow-brand-300 hover:-translate-y-0.5"
          >
